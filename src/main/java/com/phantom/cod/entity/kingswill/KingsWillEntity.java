...
public class KingsWillEntity extends Monster implements GeoEntity {
    ...
    private final ServerBossEvent bossBar =
            new ServerBossEvent(
                    this.getUUID(),
                    Component.literal("The Kings Will")
                            .withStyle(style ->
                                    style
                                            .withColor(0xDC143C)
                                            .withBold(true)
    ...
    public void registerControllers(
        ...
        KingsWillBehavior.registerAnimationController(
                this,
                controllers
        );
    }

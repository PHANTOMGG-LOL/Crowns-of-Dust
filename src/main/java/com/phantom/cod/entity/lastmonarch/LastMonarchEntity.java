...
public class LastMonarchEntity extends Monster implements GeoEntity {
    ...
    private final ServerBossEvent bossBar =
            new ServerBossEvent(
                    this.getUUID(),
                    Component.literal("The Last Monarch")
                            .withStyle(style ->
                                    style
                                            .withColor(0x4B0082)
                                            .withBold(true)
    ...
    public void registerControllers(
        ...
        LastMonarchBehavior.registerAnimationController(
                this,
                controllers
        );
    }
